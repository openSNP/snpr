  ...
  context 'as a signed-in user' do
    ...
    scenario 'the user enters a new phenotype' do
      ...
      expect(ActionMailer::Base.deliveries.first.body.parts.first.body.raw_source)
        ...
        --
        You received this email because you enabled the notifications for \
        website updates.
        You can easily change these on the website: \
        https://opensnp.org/users/1/edit#notifications
