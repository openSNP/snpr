...
ActiveRecord::Schema.define(:version => 20130124085042) do
  ...
  create_table "snps", :force => true do |t|
    ...
    t.integer  "ranking"
    t.integer  "number_of_users",    :default => 0
    t.datetime "mendeley_updated",   :default => '2012-12-29 08:24:51'
    t.datetime "plos_updated",       :default => '2012-12-29 08:24:51'
    t.datetime "snpedia_updated",    :default => '2012-12-29 08:24:51'
    t.datetime "created_at"
    t.datetime "updated_at"
  end
