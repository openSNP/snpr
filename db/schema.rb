...
ActiveRecord::Schema.define(:version => 20110830134100) do
  ...
  create_table "snps", :force => true do |t|
    ...
    t.integer  "ranking"
    t.datetime "mendeley_updated",   :default => '2011-08-07 16:41:41'
    t.datetime "plos_updated",       :default => '2011-08-07 16:41:41'
    t.datetime "snpedia_updated",    :default => '2011-08-07 16:41:41'
    t.datetime "created_at"
    t.datetime "updated_at"
  end
