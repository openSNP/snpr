...
ActiveRecord::Schema.define(version: 20_140_820_071_334) do
  ...
  add_index 'friendly_id_slugs', %w(slug sluggable_type), name: 'index_friendly_id_slugs_on_slug_and_sluggable_type', unique: true
  ...
  add_index 'snp_references', %w(paper_id paper_type), name: 'index_snp_references_on_paper_id_and_paper_type'
  ...
  add_index 'snps', %w(chromosome position), name: 'index_snps_chromosome_position'
  ...
  add_index 'user_snps_old', %w(snp_name user_id), name: 'index_user_snps_on_user_id_and_snp_name'
  add_index 'user_snps_old', ['snp_name'], name: 'index_user_snps_on_snp_name'
  add_index 'user_snps_old', %w(user_id snp_id), name: 'index_user_snps_on_user_id_and_snp_id'
