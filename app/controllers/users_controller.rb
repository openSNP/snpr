class UsersController < ApplicationController
  ...
  def show
    ...
    @snp_comments.each { |sc| @user_snp_comment_ids << sc.id }
    @snp_comment_replies = []
    ...
    @phenotype_comments.each { |pc| @user_phenotype_comment_ids << pc.id }
  ...
  def update
    ...
    if @user.update_attributes(user_params)
      ...
      if params[:user][:password] || params[:user][:avatar]
